...
public class SpecifiedFileAccess {
    ...
    private static boolean isPdfFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
            return isPdfFileType(type.fileType);
        }
    ...
    private static boolean isTxtFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
    ...
    private static boolean isApkFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
    ...
    //根据视频文件路径判断文件类型
    private static boolean isVideoFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
    ...
    private static boolean isAudioFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
    ...
    private static boolean isImageFileType(String path) {
        MediaFileType type = getFileType(path);
        if (null != type) {
